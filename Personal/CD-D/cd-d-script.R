...
training <- read.csv("training-data.csv", head=TRUE, sep=",")
summary(training)
training_description <- describe(training)

# Testing or Validation Data
testing <- read.csv("testing-data.csv", head=TRUE, sep=",")
summary(testing)
...
models_names <- c("Model 2", "Model 3", "Model 4")
...
class_1_4_cd <- dataset %>% filter(CROWN.DIAMETER > 1 & CROWN.DIAMETER <= 4)
class_4_8_cd <- dataset %>% filter(CROWN.DIAMETER > 4 & CROWN.DIAMETER <= 8)
class_8_12_cd <- dataset %>% filter(CROWN.DIAMETER > 8 & CROWN.DIAMETER <= 12)
class_12_16_cd <- dataset %>% filter(CROWN.DIAMETER > 12 & CROWN.DIAMETER <= 16)
class_16_20_cd <- dataset %>% filter(CROWN.DIAMETER > 16 & CROWN.DIAMETER <= 20)
class_20_cd <- dataset %>% filter(CROWN.DIAMETER > 20)
...
# CD
class_1_4_cd_density <- length(class_1_4_cd$CROWN.DIAMETER)
class_4_8_cd_density <- length(class_4_8_cd$CROWN.DIAMETER)
class_8_12_cd_density <- length(class_8_12_cd$CROWN.DIAMETER)
class_12_16_cd_density <- length(class_12_16_cd$CROWN.DIAMETER)
class_16_20_cd_density <- length(class_16_20_cd$CROWN.DIAMETER)
class_20_cd_density <- length(class_20_cd$CROWN.DIAMETER)
...
summary_variable_classes_table <- data.frame(
  ...
  "CD.density" = c(class_1_4_cd_density, class_4_8_cd_density, class_8_12_cd_density, class_12_16_cd_density, class_16_20_cd_density, class_20_cd_density),
  "CD.trees.ha" = c((class_1_4_cd_density/density), (class_4_8_cd_density/density), (class_8_12_cd_density/density), (class_12_16_cd_density/density), (class_16_20_cd_density/density), (class_20_cd_density/density))
)
