...
write.csv(
  testing, 
  file = "C:\\Benion\\Benion Programmings\\R\\Benion JOSTUM Project\\project-exported-tables\\testing-hd-dataset.csv", 
  quote = FALSE, row.names = TRUE)

write.table(
  testing, 
  file = "C:\\Benion\\Benion Programmings\\R\\Benion JOSTUM Project\\project-exported-tables\\testing-hd-dataset.txt", 
