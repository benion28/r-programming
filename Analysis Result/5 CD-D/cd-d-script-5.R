...
setwd("C://Benion//Benion Programmings//R//Analysis Result//5 CD-D")
...
training <- read.csv("training-data-5.csv", head=TRUE, sep=",")
summary(training)
training_description <- describe(training)

# Testing or Validation Data
testing <- read.csv("testing-data-5.csv", head=TRUE, sep=",")
summary(testing)
