...
setwd("C://Benion//Benion Programmings//R//Analysis Result//2 CD-D")
...
training <- read.csv("training-data-2.csv", head=TRUE, sep=",")
summary(training)
training_description <- describe(training)

# Testing or Validation Data
testing <- read.csv("testing-data-2.csv", head=TRUE, sep=",")
summary(testing)
