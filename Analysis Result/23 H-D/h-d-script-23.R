...
setwd("C://Benion//Benion Programmings//R//Analysis Result//23 H-D")

# Import data set
dataset <-  read.csv("full-data-10.csv", head=TRUE, sep=",")
head(dataset, n = 10)
summary(dataset)
describe(dataset)
...
training <- read.csv("training-data-10.csv", head=TRUE, sep=",")
summary(training)
training_description <- describe(training)

# Testing or Validation Data
testing <- read.csv("testing-data-10.csv", head=TRUE, sep=",")
summary(testing)
